...
export default function DashboardPage() {
  ...
  return (
  <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8 overflow-x-hidden">
    ...
    {filtered.length === 0 ? (
      ...
      <div className="space-y-3">
        {filtered.map((booking) => (
          <div
            key={booking.id}
            onClick={() => setTimelineModal(booking)}
        ...
        <div>
          <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-xl mb-5">
            <span className="text-2xl flex-shrink-0">
              {timelineModal.category_icon || '🔧'}
            </span>

            <div className="min-w-0">
              <p className="text-sm font-semibold break-words">
                {timelineModal.provider_name}
              </p>

              <p className="text-xs text-gray-500 break-words">
                {timelineModal.service_name}
              </p>
            </div>
          </div>
            ...
            events={[
              {
                ...
                actor_name: 'You',
                actor_role: 'customer',
                created_at: timelineModal.slot_date,
                notes: '',
              },
              {
                id: 2,
                from_status: 'requested',
                to_status: timelineModal.status,
                actor_name: 'Provider',
                actor_role: 'provider',
                created_at: timelineModal.slot_date,
                notes: '',
