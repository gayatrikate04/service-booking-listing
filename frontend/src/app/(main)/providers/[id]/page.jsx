...
export default function ProviderDetailPage() {
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8 overflow-x-hidden">
    ...
    <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-6 items-start">
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-card p-4 sm:p-6">
          ...
          {reviews.length > 0 ? (
            <>
              {/* Rating summary */}
              <div className="grid grid-cols-1 md:grid-cols-[auto_1fr] gap-6 mb-6 pb-6 border-b border-gray-100">
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm">
                No reviews yet. Book this provider and be the first!
              </p>
            </div>
          )}
        </div>
      ...
      <div
        id="booking-widget"
        className="bg-white border border-gray-200 rounded-xl shadow-card p-5 xl:sticky xl:top-20 space-y-4"
      >
        <div>
          ...
          <div className="bg-gray-50 rounded-lg p-3 space-y-1.5">
            ...
            <div className="flex justify-between gap-4 text-sm">
              ...
              <span className="font-medium text-blue-600 text-right">
                ${selectedService.price_per_hour}/{provider.price_unit}
              </span>
            </div>
          </div>
        )}
