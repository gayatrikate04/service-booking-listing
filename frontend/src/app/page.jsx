    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      ...
      <section className="bg-white border-b border-gray-200 py-14 sm:py-20 px-4 sm:px-6">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-sm sm:text-base text-gray-500 max-w-sm mx-auto leading-relaxed mb-8 px-2">
            Book vetted home services, wellness, tutoring, and more —
            instantly and reliably.
          </p>

          {/* Search bar */}
          <div className="flex flex-col sm:flex-row max-w-md mx-auto bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
            <input
              type="text"
              placeholder="What service are you looking for?"
              className="flex-1 px-4 py-3 text-sm text-black placeholder-gray-400 bg-white outline-none min-w-0"
            />

            <Link
              href="/providers"
              className="px-5 py-3 bg-black text-white text-sm font-medium hover:bg-gray-800 transition-colors flex items-center justify-center whitespace-nowrap sm:rounded-r-xl"
            >
              Search
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
          {MOCK_CATEGORIES.map((cat) => (
            <Link
              ...
              className="group bg-white border border-gray-200 rounded-2xl p-4 sm:p-6 text-center shadow-sm hover:border-gray-400 hover:-translate-y-1 hover:shadow-md transition-all duration-200"
            >
      ...
      {/* ── HOW IT WORKS ── */}
      <section id="how-it-works" className="border-t border-gray-200 py-12 sm:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            {[
              {
                ...
                step: '01',
                title: 'Search & Filter',
                text: 'Browse verified providers by category, location, price, and ratings.'
              },
              {
                icon: '📅',
                step: '02',
                title: 'Book Instantly',
                text: 'Choose a service, pick a date and time slot, confirm in minutes.'
              },
              {
                icon: '⭐',
                step: '03',
                title: 'Rate & Review',
                text: 'After your service, share your experience to help the community.'
              },
            ].map((item) => (
              <div
                key={item.step}
                className="bg-white border border-gray-200 rounded-2xl p-5 sm:p-6 shadow-sm text-center"
              >
      ...
      <section className="py-12 sm:py-16 border-t border-gray-200">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl shadow-sm px-4 sm:px-8 py-8 sm:py-10 grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-16 sm:pb-20">
        <div className="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 sm:p-10 text-center">
          ...
          <Link
            href="/onboarding"
            className="inline-flex items-center justify-center gap-2 bg-black text-white text-sm font-medium px-5 py-2.5 rounded-xl hover:bg-gray-800 transition-colors"
          >
            Become a Provider →
          </Link>
        </div>
