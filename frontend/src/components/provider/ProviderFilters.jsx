...
export function ProviderFilters({ filters, onChange, onApply }) {
  ...
  return (
  <aside className="w-full lg:max-w-xs shrink-0 h-fit lg:sticky lg:top-24 overflow-hidden">

    <div className="bg-white border border-gray-200 rounded-2xl p-4 sm:p-5 space-y-6">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="text-xs text-gray-500 hover:text-black hover:underline transition whitespace-nowrap"
        >
          Clear all
        </button>
      </div>
          ...
          {MOCK_CATEGORIES.map((cat) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <span className="text-sm text-gray-700 group-hover:text-black transition break-words">
                  {cat.name}
                </span>
              </div>
