...
export function ReviewForm({ booking, onSuccess, onCancel }) {
  ...
  <div>
    ...
    {/* Provider info */}
    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg mb-5 overflow-hidden">
    ...
    {error && (
      <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg text-sm text-red-700 break-words">
        {error}
      </div>
    )}
